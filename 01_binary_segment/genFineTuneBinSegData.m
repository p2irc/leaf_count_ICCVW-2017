function genFineTuneBinSegData()
...
g_SIZE_IMG = 224;
g_SIZE_STEP = 50; % step size to generate image from the original
g_NumOutDirs = 30; % number of directories for the images
inBasePath = '/media/aich/DATA/databases/leaf_cvppp2017/lcc_bbox';
outBasePath = '/media/aich/DATA/databases/lcc_finetune';
rgbPath = 'rgb';
fgPath = 'fg';
