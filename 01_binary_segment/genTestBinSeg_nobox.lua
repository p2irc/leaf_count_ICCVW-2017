...
local pathInTestData = '/media/aich/DATA/databases/leaf_cvppp2017/test_binSeg/rgb_224_nobox/';
local pathOutTestData = '/media/aich/DATA/databases/leaf_cvppp2017/test_binSeg/fg_mat_nobox/';
local subDirs = {[1]='A1', [2]='A2', [3]='A3', [4]='A4', [5]='A5'};
