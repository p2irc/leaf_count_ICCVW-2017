function genTestDataBinSeg_nobox()
...
inRgbPath = '/media/aich/DATA/databases/leaf_cvppp2017/test_binSeg/rgb';
postImPath = {'A1','A2','A3','A4','A5'};
outRgbPath = '/media/aich/DATA/databases/leaf_cvppp2017/test_binSeg/rgb_224_nobox';
...
%                end
    ...
    switch i
        case 1
            test_binSeg_A1 = specStruct;
        case 2
            test_binSeg_A2 = specStruct;
        case 3
            test_binSeg_A3 = specStruct;
        case 4
            test_binSeg_A4 = specStruct;            
        case 5
            test_binSeg_A5 = specStruct;                        
        otherwise
...
% save all mat files
save('./test_binSeg.mat', 'test_binSeg_A1', 'test_binSeg_A2', ...
        'test_binSeg_A3', 'test_binSeg_A4', 'test_binSeg_A5');
restoredefaultpath;
