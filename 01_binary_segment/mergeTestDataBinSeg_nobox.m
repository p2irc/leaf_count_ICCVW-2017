...
for i = 1:length(postPath)
    switch i
        case 1
            specStruct = test_binSeg_A1;
        case 2
            specStruct = test_binSeg_A2;
        case 3
            specStruct = test_binSeg_A3;
        case 4
            specStruct = test_binSeg_A4;
        case 5
            specStruct = test_binSeg_A5;            
        otherwise
...
save('Failed_Files_BS_Test_nobox.mat', 'listFailure');
