...
local pathTrainData = '/media/aich/DATA/lcc_finetune_dat/rgb';
local pathTrainLabels = '/media/aich/DATA/lcc_finetune_dat/fg';

-- get mean estimate for of the training dataset
local meanData = torch.load("mean_finetune.dat")/MAX_IMG_VAL;
...
-- specify log file
trainLogger = optim.Logger('./logs/train_segnet_01_part2.log');
