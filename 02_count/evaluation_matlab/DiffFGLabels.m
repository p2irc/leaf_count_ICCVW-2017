...
function score = DiffFGLabels(inLabel,gtLabel)
...
% score: difference of the number of foreground labels
...
score = ( double(maxInLabel-minInLabel) - double(maxGtLabel-minGtLabel));
